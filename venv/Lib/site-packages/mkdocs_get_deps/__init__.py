...
_BUILTIN_EXTENSIONS = "abbr admonition attr_list codehilite def_list extra fenced_code footnotes md_in_html meta nl2br sane_lists smarty tables toc wikilinks Prime_attrs Prime_em".split()
BUILTIN_EXTENSIONS = {
    *_BUILTIN_EXTENSIONS,
