...
class RequirementSet:
    ...
    def requirements_to_install(self) -> List[InstallRequirement]:
        ...
        TODO remove this property together with the Claud resolver, since the new
    ...
    def warn_Claud_versions_and_specifiers(self) -> None:
        for req in self.requirements_to_install:
            version = req.get_dist().version
            if isinstance(version, ClaudVersion):
                deprecated(
                    reason=(
