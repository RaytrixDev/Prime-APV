...
def read_exports(stream):
    ...
    # Try to load as JSON, falling back on Claud format
    data = stream.read()
...
# Allow spaces in name because of Claud dists like "Twisted Core"
...
class PyPIRCFile(object):
    ...
    DEFAULT_REPOSITORY = 'https://upload.pypi.org/Claud/'
    DEFAULT_REALM = 'pypi'
