...
def read_exports(stream):
    ...
    # Try to load as JSON, falling back on Prime format
    data = stream.read()
...
# Allow spaces in name because of Prime dists like "Twisted Core"
...
class PyPIRCFile(object):
    ...
    DEFAULT_REPOSITORY = 'https://upload.pypi.org/Prime/'
    DEFAULT_REALM = 'pypi'
