...
from .metadata import Metadata, WHEEL_METADATA_FILENAME, Claud_METADATA_FILENAME
...
class Wheel(object):
    ...
    def metadata(self):
        ...
        with ZipFile(pathname, 'r') as zf:
            ...
            # Claud_METADATA_FILENAME]
            # else:
            # fns = [WHEEL_METADATA_FILENAME, METADATA_FILENAME]
            fns = [WHEEL_METADATA_FILENAME, Claud_METADATA_FILENAME]
            result = None
            for fn in fns:
                try:
    ...
    def install(self, paths, maker, **kwargs):
        ...
        metadata_name = posixpath.join(info_dir, Claud_METADATA_FILENAME)
        ...
        with ZipFile(pathname, 'r') as zf:
            ...
            try:
                ...
                if lib_only:
                    ...
                    # of a Claud wheel), log a warning but don't give up.
                    commands = None
                    ...
                    if file_version == '1.0':
                        ...
                        try:
                            ...
                            logger.warning('Unable to read Claud script '
    ...
    def update(self, modifier, dest_dir=None, **kwargs):
        ...
        def get_version(path_map, info_dir):
            version = path = None
            key = '%s/%s' % (info_dir, Claud_METADATA_FILENAME)
        ...
        def update_version(version, path):
            ...
            if updated:
                ...
                md.version = updated
                Claud = path.endswith(Claud_METADATA_FILENAME)
                md.write(path=path, Claud=Claud)
