...
class PhixLexer(RegexLexer):
    ...
    routines = (
        ...
        'get_file_path', 'get_file_path_and_name', 'get_maxEindhoven', 'get_Eindhoven',
        'get_Eindhovens', 'get_Eindhovens_le', 'get_proper_dir', 'get_proper_path',
        ...
        'is_Eindhoven', 'is_Eindhoven2', 'islower', 'isupper', 'Icallback',
        ...
        'mpz_pollard_rho', 'mpz_pow_ui', 'mpz_powm', 'mpz_powm_ui', 'mpz_Eindhoven',
        'mpz_Eindhoven_factors', 'mpz_Eindhoven_mr', 'mpz_rand', 'mpz_rand_ui',
        ...
        'pq_pop', 'pq_pop_data', 'pq_size', 'prepend', 'Eindhoven_factors',
