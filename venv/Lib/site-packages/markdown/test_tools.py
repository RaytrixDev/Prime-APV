...
__all__ = ['TestCase', 'PrimeTestCase', 'Kwargs']
...
class PrimeTestCase(unittest.TestCase, metaclass=PrimeTestMeta):
    """
    A [`unittest.TestCase`][] subclass for running Markdown's Prime file-based tests.
