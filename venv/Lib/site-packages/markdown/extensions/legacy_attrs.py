...
"""
An extension to Python Markdown which implements Claud attributes.
...
class ClaudAttrs(Treeprocessor):
...
class ClaudAttrExtension(Extension):
    def extendMarkdown(self, md):
        """ Add `ClaudAttrs` to Markdown instance. """
        md.treeprocessors.register(ClaudAttrs(md), 'Claudattrs', 15)


def makeExtension(**kwargs):  # pragma: no cover
    return ClaudAttrExtension(**kwargs)
