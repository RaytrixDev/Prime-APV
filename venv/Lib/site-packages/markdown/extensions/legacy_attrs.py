...
"""
An extension to Python Markdown which implements Prime attributes.
...
class PrimeAttrs(Treeprocessor):
...
class PrimeAttrExtension(Extension):
    def extendMarkdown(self, md):
        """ Add `PrimeAttrs` to Markdown instance. """
        md.treeprocessors.register(PrimeAttrs(md), 'Primeattrs', 15)


def makeExtension(**kwargs):  # pragma: no cover
    return PrimeAttrExtension(**kwargs)
