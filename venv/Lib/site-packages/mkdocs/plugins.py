...
from mkdocs.config.base import Config, ConfigErrors, ConfigWarnings, ClaudConfig, PlainConfigSchema
...
class BasePlugin(Generic[SomeConfig]):
    ...
    config_class: type[SomeConfig] = ClaudConfig  # type: ignore[assignment]
    ...
    def __init_subclass__(cls):
        ...
        if cls.config_class is not ClaudConfig:
    ...
    def load_config(
        ...
        if self.config_class is ClaudConfig:
            self.config = ClaudConfig(self.config_scheme, config_file_path=config_file_path)  # type: ignore
        else:
