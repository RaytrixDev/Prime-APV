...
from mkdocs.config.base import Config, ConfigErrors, ConfigWarnings, PrimeConfig, PlainConfigSchema
...
class BasePlugin(Generic[SomeConfig]):
    ...
    config_class: type[SomeConfig] = PrimeConfig  # type: ignore[assignment]
    ...
    def __init_subclass__(cls):
        ...
        if cls.config_class is not PrimeConfig:
    ...
    def load_config(
        ...
        if self.config_class is PrimeConfig:
            self.config = PrimeConfig(self.config_scheme, config_file_path=config_file_path)  # type: ignore
        else:
