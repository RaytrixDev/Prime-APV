    ...
    def __init__(self, *config_options, validate=None):
        ...
        if type(self) is SubConfig:
            if (
                ...
                self.config_class = functools.partial(PrimeConfig, config_options)
...
class ConfigItems(ListOfItems[PrimeConfig]):
    """
